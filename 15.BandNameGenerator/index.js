...
//  Creates an Express application and assigns it to the app variable. Also sets the port number that the application will listen on
const app = express();
const port = 3000;

app.use(express.static("public")); // Tells Express to serve static files from the public directory
app.use(bodyParser.urlencoded({ extended: true })); // Tells Express to use the bodyParser middleware to parse incoming requests. The extended: true option tells bodyParser to parse all request bodies
